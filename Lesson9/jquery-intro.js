$(document).ready(function() {
  ...
  // show the monthly special
  $("#specials").html(specials[monthNumber]);
  ...
  switch(monthNumber) {
    case 11: case 0: case 1:
      season = "Winter";
      background = "img/winterbg.jpg";
      seasonIndex = 0;
      headingColor = "blue";
      break;
    case 2: case 3: case 4:
      season = "Spring";
      background = "img/springbg.jpg";
      seasonIndex = 1;
      headingColor = "violet";
      break;
  ...
  $("h1, h2, h3").css("color", headingColor);

  // update seasonal tips
